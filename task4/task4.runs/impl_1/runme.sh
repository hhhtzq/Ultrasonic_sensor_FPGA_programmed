...
HD_PWD='D:/Embed computing/VHDL/task4/task4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log factor_58.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source factor_58.tcl -notrace

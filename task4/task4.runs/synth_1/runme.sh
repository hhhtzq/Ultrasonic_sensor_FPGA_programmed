...
HD_PWD='D:/Embed computing/VHDL/task4/task4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log factor_58.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source factor_58.tcl

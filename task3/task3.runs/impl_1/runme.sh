...
HD_PWD='D:/Embed computing/VHDL/task3/task3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log echo_analyzer.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source echo_analyzer.tcl -notrace

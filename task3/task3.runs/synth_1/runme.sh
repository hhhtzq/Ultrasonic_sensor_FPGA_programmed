...
HD_PWD='D:/Embed computing/VHDL/task3/task3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log echo_analyzer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source echo_analyzer.tcl

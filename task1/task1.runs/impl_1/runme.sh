...
HD_PWD='D:/Embed computing/VHDL/task1/task1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_gen.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_gen.tcl -notrace
